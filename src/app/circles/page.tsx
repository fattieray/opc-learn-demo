...
// Mock feed data
const feedItems = [
  { id: "f1", type: "submit", userId: "user-qi", user: "思琪", avatar: "琪", action: "提交了种草文案作业", course: "小红书种草文案速成", courseId: "r-micro-01", time: "10分钟前", likes: 3 },
  { id: "f2", type: "praise", userId: "coach-lin", user: "林雪", avatar: "L", role: "coach", action: "认可了小林的文案进步", target: "小林", time: "30分钟前" },
  { id: "f3", type: "review", userId: "user-yue", user: "小月", avatar: "月", action: "点评了阿杰的详情页文案", course: "电商详情页卖点提炼", courseId: "r-micro-02", time: "1小时前", likes: 2 },
  { id: "f4", type: "complete", userId: "user-han", user: "小韩", avatar: "韩", action: "完成了旅行笔记速写课程", course: "小红书旅行种草笔记速写", courseId: "t-micro-01", time: "2小时前" },
  { id: "f5", type: "help", userId: "coach-lin", user: "林雪", avatar: "L", role: "coach", action: "回答了阿杰关于AIDA的问题", course: "小红书种草文案速成", courseId: "r-micro-01", time: "3小时前", likes: 5, isExpertAnswer: true },
  { id: "f6", type: "certificate", userId: "user-yue", user: "小月", avatar: "月", action: "获得了「种草文案」技能认证", time: "5小时前" },
  { id: "f7", type: "submit", userId: "user-ming", user: "阿明", avatar: "明", action: "提交了B2B产品文案作业", course: "1688产品详情页文案速写", courseId: "m-micro-01", time: "6小时前", likes: 1 },
  { id: "f8", type: "help", userId: "user-cheng", user: "小程", avatar: "程", action: "帮助小鹿理解5感写作法", course: "小红书旅行种草笔记速写", courseId: "t-micro-01", time: "8小时前", likes: 4 },
  { id: "f9", type: "praise", userId: "coach-chen", user: "陈野", avatar: "C", role: "coach", action: "认可了小韩的旅行叙事能力", target: "小韩", time: "昨天" },
  { id: "f10", type: "complete", userId: "user-lin", user: "小林", avatar: "林", action: "完成了体系课第3模块", course: "小红书内容运营全栈能力", courseId: "r-sys-01", time: "昨天" },
];
...
// Help board items
const helpRequests = [
  { id: "h1", userId: "user-jie", user: "阿杰", avatar: "杰", question: "种草文案的开头怎么写才能抓住注意力？", course: "小红书种草文案速成", courseId: "r-micro-01", answers: 1, time: "20分钟前", expertAnswered: true },
  { id: "h2", userId: "user-lu", user: "小鹿", avatar: "鹿", question: "5感写作法的「触感」怎么融入旅行笔记？", course: "小红书旅行种草笔记速写", courseId: "t-micro-01", answers: 0, time: "1小时前", expertAnswered: false },
  { id: "h3", userId: "user-cheng", user: "小程", avatar: "程", question: "B2B产品文案怎么避免太技术化？", course: "1688产品详情页文案速写", courseId: "m-micro-01", answers: 0, time: "2小时前", expertAnswered: false },
  { id: "h4", userId: "user-lin", user: "小林", avatar: "林", question: "体系课的作业评分标准是什么？", course: "小红书内容运营全栈能力", courseId: "r-sys-01", answers: 2, time: "3小时前", expertAnswered: true },
  { id: "h5", userId: "user-ming", user: "阿明", avatar: "明", question: "如何平衡文案的商业性和真实性？", course: "电商详情页卖点提炼", courseId: "r-micro-02", answers: 1, time: "5小时前", expertAnswered: false },
];
                    ...
                    <div key={h.id} className="p-3 rounded-lg bg-gray-50/80 border border-gray-100/50">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1.5">
                          ...
                          <Link href={`/users/${h.userId}`} className="text-[10px] text-gray-500 hover:text-[#2DD4A8] transition-colors">{h.user}</Link> · {h.time}
                        </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <Link href={`/users/${item.userId}`} className="text-xs font-medium text-gray-900 hover:text-[#2DD4A8] transition-colors">
                            {item.user}
                          </Link>
